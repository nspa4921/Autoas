  ...
  return (
    <div id="service"  className={classes.section}>
      ...
      <GridItem xs={12} sm={12} md={12}>
          <h2 className={classes.title}>TJÄNSTER</h2>
          <br></br>
          <Image />
          <br></br>
        </GridItem>
        ...
        <GridContainer className="explanation">
          <GridItem xs={12} sm={12} md={3}>
            <InfoArea
              title="Klargøring"
              description="Kosmetiska förbättringar av bilens exteriör samt interiör"
          ...
          <GridItem xs={12} sm={12} md={3}>
            <InfoArea
              title="Lugtfjernelse "
              description="Borttagande av svåra obehagliga lukter orsakade av: brända föremål, cigarettrök, lämningar av husdjur"
          ...
          <GridItem xs={12} sm={12} md={3}>
            <InfoArea
              title="Lakbehandling"
              description="Eliminering av alla synliga färgdefekter på lacken samt monterade delar (med hjälp av polering, lackning, utbyten)"
              icon={DoneOutlineSharpIcon}
              iconColor="primary"
              vertical
            />
            ...
            <InfoArea
              ...
              description="Försäkringsfall täckta inom ovan beskrivna tjänster.."
              icon={DoneOutlineSharpIcon}
              iconColor="primary"
              vertical
            />
