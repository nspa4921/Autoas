...
export default function LandingPage(props) {
  ...
  const slider = (
    ...
    >
      ...
      <GridContainer>
            <GridItem xs={4} sm={12} md={12} boxShadow={3} className={classes.container} style={{backgroundColor: bgColors.Default}}>
            <h1> BILPLEJE </h1>
            </GridItem>
          </GridContainer>
      </div>
      ...
      <GridContainer >
            <GridItem xs={4} sm={12} md={12} align="center" className={classes.container} style={{backgroundColor: bgColors.Default}}>
              <h1> REPARATION </h1>
            </GridItem>
          </GridContainer>
      </div>
